#!/usr/bin/env python3
"""
Upload trained model and files to Hugging Face Space
"""
...
try:
    ...
    for file in files_to_upload:
        if os.path.exists(file):
            ...
            api.upload_file(
                ...
                repo_id=space_id,
                repo_type="space",
                commit_message=f"Add {file} - trained model and documentation"
            )
    ...
    print(f"Error: {e}")
    print()
    print("This might require authentication. Please provide a Hugging Face token.")
